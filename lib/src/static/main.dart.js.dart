...
l=T.x(b2,a4.dx,"img")
T.an(l,"alt","pub logo")
T.an(l,"src","https://raw.githubusercontent.com/kurtyu/unpub-2.1.0-docker/main/assets/pub-dev-logo-2x.png")
a4.B(l)
k=T.aE(b2,p)
a4.t(k,"_flex-space")
a4.H(k)
...
a4.t(a0,a8)
T.an(a0,"name","q")
T.an(a0,"placeholder","Search Packages")
a4.H(a0)
m=O.yK(a0)
a4.r=m
a4.sjx(H.i([m],t.i0))
